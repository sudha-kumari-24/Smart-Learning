      ...
      <div className="stress-grid">
        <div className="card">
          ...
          <button 
            ...
            onClick={() => handleStartPosture('breathing')}
          >
            Start Session
          </button>
        </div>
        ...
        <div className="card">
          ...
          <button 
            className="btn-primary-sm"
            onClick={() => handleStartPosture('body_scan')}
          >
            Start Session
          </button>
        </div>
        ...
        <div className="card">
          ...
          <button 
            className="btn-primary-sm"
            onClick={() => handleStartPosture('focus_reset')}
          >
            Start Session
          </button>
        </div>
        ...
        <div className="card">
          ...
          <button 
            className="btn-primary-sm"
            onClick={() => handleStartPosture('desk_stretch')}
          >
            Start Session
          </button>
        </div>
        ...
        <div className="card">
          ...
          <button 
            className="btn-primary-sm"
            onClick={() => handleStartPosture('neck_shoulder')}
          >
            Start Session
          </button>
        </div>
        ...
        <div className="card">
          ...
          <button 
            className="btn-primary-sm"
            onClick={() => handleStartPosture('eye_exercise')}
          >
            Start Session
          </button>
        </div>
